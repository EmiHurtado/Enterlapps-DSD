...
-- QNegada	=>  Location: PIN_7,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \inst6|Equal0~2_combout\ = (\inst6|contador\(16) & (\inst6|contador\(14) & (!\inst6|contador\(17) & !\inst6|contador\(15))))
...
-- Equation(s):
-- \inst2|Q~0_combout\ = (\Data1~combout\ & ((\inst2|Q~reg0_regout\) # (!\Data2~combout\))) # (!\Data1~combout\ & (\inst2|Q~reg0_regout\ & !\Data2~combout\))
...
-- Equation(s):
-- \inst2|QN~0_combout\ = (\Data1~combout\ & (\inst2|QN~reg0_regout\ & \Data2~combout\)) # (!\Data1~combout\ & ((\inst2|QN~reg0_regout\) # (\Data2~combout\)))
...
-- Equation(s):
-- \inst6|contador~10_combout\ = (!\inst6|Equal0~7_combout\ & \inst6|Add0~22_combout\)
...
-- Equation(s):
-- \inst6|Equal0~7_combout\ = (\inst6|contador\(1) & (\inst6|Equal0~6_combout\ & (\inst6|Equal0~5_combout\ & \inst6|Equal0~4_combout\)))
