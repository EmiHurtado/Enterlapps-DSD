...
ENTITY 	Practica1 IS
	...
	Sel0 : IN std_logic;
	Sel1 : IN std_logic;
	QNegada : OUT std_logic
	);
END Practica1;

-- Design Ports Information
-- Q	=>  Location: PIN_3,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- QNegada	=>  Location: PIN_9,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- Sel1	=>  Location: PIN_48,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- Sel0	=>  Location: PIN_47,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- Data1	=>  Location: PIN_40,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- Data2	=>  Location: PIN_41,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \inst6|Equal0~0_combout\ = (\inst6|contador\(24) & (\inst6|contador\(22) & (!\inst6|contador\(23) & \inst6|contador\(0))))
...
-- Equation(s):
-- \inst6|Equal0~1_combout\ = (\inst6|contador\(18) & (\inst6|contador\(19) & (\inst6|contador\(20) & \inst6|contador\(21))))
...
-- Equation(s):
-- \inst6|Equal0~2_combout\ = (!\inst6|contador\(15) & (\inst6|contador\(14) & (!\inst6|contador\(17) & \inst6|contador\(16))))
...
-- Equation(s):
-- \inst6|Equal0~3_combout\ = (\inst6|contador\(11) & (\inst6|contador\(13) & (\inst6|contador\(12) & !\inst6|contador\(10))))
...
-- Equation(s):
-- \inst6|Equal0~4_combout\ = (\inst6|Equal0~1_combout\ & (\inst6|Equal0~2_combout\ & (\inst6|Equal0~3_combout\ & \inst6|Equal0~0_combout\)))
...
-- Equation(s):
-- \inst6|Equal0~7_combout\ = (\inst6|contador\(1) & (\inst6|Equal0~5_combout\ & (\inst6|Equal0~4_combout\ & \inst6|Equal0~6_combout\)))
...
-- Equation(s):
-- \inst6|contador~1_combout\ = (!\inst6|Equal0~7_combout\ & \inst6|Add0~44_combout\)
...
-- Equation(s):
-- \inst6|contador~3_combout\ = (\inst6|Add0~40_combout\ & !\inst6|Equal0~7_combout\)
...
-- Equation(s):
-- \inst6|contador~4_combout\ = (\inst6|Add0~38_combout\ & !\inst6|Equal0~7_combout\)
...
-- Equation(s):
-- \inst6|contador~6_combout\ = (\inst6|Add0~32_combout\ & !\inst6|Equal0~7_combout\)
...
-- Equation(s):
-- \inst6|contador~7_combout\ = (!\inst6|Equal0~7_combout\ & \inst6|Add0~28_combout\)
...
-- Equation(s):
-- \inst6|contador~11_combout\ = (!\inst6|Equal0~7_combout\ & \inst6|Add0~12_combout\)
...
-- Equation(s):
-- \inst4|Q~0_combout\ = (\Sel1~combout\ & (((\Sel0~combout\)))) # (!\Sel1~combout\ & ((\Sel0~combout\ & (\inst2|Q~reg0_regout\)) # (!\Sel0~combout\ & ((\inst|Q~reg0_regout\)))))
...
PORT MAP (
	dataa => \Sel1~combout\,
	datab => \inst2|Q~reg0_regout\,
	datac => \inst|Q~reg0_regout\,
	datad => \Sel0~combout\,
...
PORT MAP (
	dataa => \Sel1~combout\,
	datab => \inst3|Q~reg0_regout\,
	datac => \inst1|Q~reg0_regout\,
	datad => \inst4|Q~0_combout\,
...
-- Equation(s):
-- \inst5|Q~1_combout\ = (\inst5|Q~0_combout\ & (((!\Sel0~combout\) # (!\inst1|Q~reg0_regout\)))) # (!\inst5|Q~0_combout\ & (\inst2|QN~reg0_regout\ & ((\Sel0~combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst5|Q~0_combout\,
	datab => \inst2|QN~reg0_regout\,
	datac => \inst1|Q~reg0_regout\,
	datad => \Sel0~combout\,
